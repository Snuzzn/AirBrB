    ...
    <>
      ...
      <div className="flex flex-col gap-1 justify-center">
        ...
        <input type="text" name="title" value={formData.title} onChange={updateFormData}
          required className="p-2 border border-gray-300 rounded-lg" aria-label="input title" />
      </div>
      {/* Address */}
      <div className="flex flex-col gap-1 justify-center">
        <label>Address</label>
        <input type="text" name="street" value={formData.address.street} onChange={updateFormData}
          required className="p-2 border border-gray-300 rounded-lg" aria-label="input address" />
      </div>
      <div className="flex flex-col gap-1 justify-center">
        <label>City</label>
        <input type="text" name="city" value={formData.address.city} onChange={updateFormData}
          required className="p-2 border border-gray-300 rounded-lg" aria-label="input city" />
      </div>
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
        ...
        <div className="relative flex flex-col gap-1 justify-center">
          ...
          <input type="number" required name="price" value={formData.price} onChange={updateFormData}
            className="p-2 pl-7 border border-gray-300 rounded-lg" aria-label="input price" />
        </div>
        <div className="relative flex flex-col gap-1 justify-center">
          ...
          <input type="number" required name="bathrooms"
            ...
            className="p-2 pl-7 border border-gray-300 rounded-lg" aria-label="input number of bathrooms" />
        </div>
      </div>
    </>
  )
